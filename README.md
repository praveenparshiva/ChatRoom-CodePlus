...
The backend handles API routes, MongoDB connection, authentication, and JWT.
...
The backend server runs on PORT from .env.
...
NEXT_PUBLIC_API_URL=<optional: API URL if calling backend>
...
CodeEditor Frontend	Vercel (recommended)	Next.js optimized, or Netlify with Next.js plugin
Scripts
...
git push origin feature/my-featur
